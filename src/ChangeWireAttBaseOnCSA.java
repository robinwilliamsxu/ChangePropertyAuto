...
public class ChangeWireAttBaseOnCSA implements IXLogicAction, IXIntegratorAction, IXHarnessAction
    {
    ...
    public boolean execute(IXApplicationContext context) {
        ...
        cntx.getOutputWindow().clear();
                ...
                // Open PopUp Dialog
        WireAttributes dialog = new WireAttributes(new javax.swing.JFrame(), true);
